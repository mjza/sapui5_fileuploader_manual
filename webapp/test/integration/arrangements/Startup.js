sap.ui.define([
	"sap/ui/test/Opa5",
	"com/mjzsoft/FileUploader0Manual/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function (Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("com.mjzsoft.FileUploader0Manual.test.integration.arrangements.Startup", {
		...
		iStartMyApp: function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "com.mjzsoft.FileUploader0Manual",
					async: true
				},
				hash: oOptions.hash,
